...
'''
v2514 -> S10Q12B_2: Since your admission, have you joined or participated in Classes in parenting or child
rearing skills?
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Child Rearing Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Child Rearing Group Members")
plt.bar_label(
    bars2,
