...
'''
v2515 -> S10Q12B_3: Since your admission, have you joined or participated in Classes in life skills and
community adjustment (including anger management, conflict resolution, personal finance, etc.)?
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Life Skill Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Life Skill Group Members")
plt.bar_label(
    bars2,
