...
'''
v2511 -> S10Q12A_3: Since your admission to prison on [MOST RECENT ADMISSION DATE], have you
joined or participated in - Inmate assistance groups (for example, inmate liaison, advisory, or worker's
councils) or inmate counseling groups?
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Inmate-Assistance Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Inmate-Assistance Group Members")
plt.bar_label(
    bars2,
