...
'''
v2516 -> S10Q12B_4: Since your admission, have you joined or participated in Other Pre-release programs
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Other Pre-Release Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Other Pre-Release Group Members")
plt.bar_label(
    bars2,
