...
'''
v2510 -> S10Q12A_2: Since your admission to prison on [MOST RECENT ADMISSION DATE], have you
joined or participated in - An ethnic/racial organization (for example, NAACP, African American or
Black Culture Group, Hispanic Committee, Aztlan, or Lakota)?
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Race/Ethnic Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Race/Ethnic Group Members")
plt.bar_label(
    bars2,
