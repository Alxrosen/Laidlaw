...
'''
V2513 -> S10Q12B_1: Since your admission, have you joined or participated in Employment counseling
(including how to find a job, interviewing skills)?
...
plt.ylabel("% of Total")
plt.title("Rule Violations By Employment Counceling Group Members")
plt.bar_label(
    bars1,
...
plt.ylabel("% of Total")
plt.title("Rule Violations By NON-Employment Counseling Group Members")
plt.bar_label(
    bars2,
