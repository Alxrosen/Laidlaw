...
df_statsbinary['v2542'] = df_statsbinary['v2542'].apply(lambda v: 1 if v == 'Yes' else 0)
...
df_statsbinary = df_statsbinary.rename(columns={
    'v0029': 'control_race_White',
    'v0030': 'control_race_Black',
    'v0031': 'control_race_American Indian Or Alaskan Native',
    'v0032': 'control_race_Asian',
    'v0033': 'control_race_Hawaiian Or Pacific Islander',
    'v0034': 'control_race_Other',
    'v0035': 'control_race_Unknown'
})
...
# By-Facility Factor -- 
'''
Note: This data only includes State Facilities. Federal are in the other data set
Removed because smaller sample size in physical assault of staff violations df
'''
...
# Age at first arrest
print(df_statsbinary['v1198'].value_counts())
...
output = df_statsbinary['v2542']
inputs = df_statsbinary.drop(['v2542', 'v0717'], axis = 1)
