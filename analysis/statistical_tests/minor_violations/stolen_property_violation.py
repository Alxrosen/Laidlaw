...
variables = df[['v2500',                            # Education
                ...
                'v2524',                            # stolen property violations
                'v2525',                            # count stolen property violations
                'v0037', 'v0038', 'v0039', #'v0040', 
                'v0041', # Race (Allocated)
...
# stolen property rule violation count
df_statsbinary['v2524'] = df_statsbinary['v2524'].apply(lambda v: 1 if v == 'Yes' else 0)
df_statsbinary['v2525'] = np.where(
    df_statsbinary['v2524'] == 0,  
    0,                       
    df_statsbinary['v2525']      
)
print(df_statsbinary['v2525'].value_counts())
df_statsbinary['v2525'] = df_statsbinary['v2525'].apply(lambda v: int(v) if not \
                                            (v == 'Blank' or
                                            v == 'Don\'t know' or
                                            v == 'Refused')
                                            else None)
df_statsbinary = df_statsbinary.dropna(subset=['v2525'])
...
'''
race_cols = ['v0037', 'v0038', 'v0039', 'v0041', 'v0042', 'v0043'] #'v0040', 
...
df_statsbinary = df_statsbinary.rename(columns={
    ...
    #'v0040': 'control_race_Asian',      # Dropped bc no one
...
output = df_statsbinary['v2525']
inputs = df_statsbinary.drop(['v2524', 'v2525', 'v0717'], axis = 1)    
