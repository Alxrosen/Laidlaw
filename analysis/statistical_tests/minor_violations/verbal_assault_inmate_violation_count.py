...
variables = df[['v2500',                            # Education
                ...
                'v2532',                            # verbal assault inmate violations
                'v2533',                            # count verbal assault inmate violations
...
df_statsbinary['v2532'] = df_statsbinary['v2532'].apply(lambda v: 1 if v == 'Yes' else 0)
df_statsbinary['v2533'] = np.where(
    df_statsbinary['v2532'] == 0,  
    0,                       
    df_statsbinary['v2533']      
)
print(df_statsbinary['v2533'].value_counts())
df_statsbinary['v2533'] = df_statsbinary['v2533'].apply(lambda v: int(v) if not \
                                            (v == 'Blank' or
                                            v == 'Don\'t know' or
                                            v == 'Refused')
                                            else None)
df_statsbinary = df_statsbinary.dropna(subset=['v2533'])
...
output = df_statsbinary['v2533']
inputs = df_statsbinary.drop(['v2532', 'v2533', 'v0717'], axis = 1)    
