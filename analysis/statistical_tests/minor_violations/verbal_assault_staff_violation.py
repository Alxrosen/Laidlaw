...
'''
NOTE: there are 9 countr of "99 violations"... May want to drop those. Also, some of these seem unreliable
...
variables = df[['v2500',                            # Education
                ...
                'v2528',                            # verbal assault on staff violations
                'v2529',                            # count verbal assault on staff violations
...
# verbal assault on staff rule violation count
df_statsbinary['v2528'] = df_statsbinary['v2528'].apply(lambda v: 1 if v == 'Yes' else 0)
df_statsbinary['v2529'] = np.where(
    df_statsbinary['v2528'] == 0,  
    0,                       
    df_statsbinary['v2529']      
)
print(df_statsbinary['v2529'].value_counts())
df_statsbinary['v2529'] = df_statsbinary['v2529'].apply(lambda v: int(v) if not \
                                            (v == 'Blank' or
                                            v == 'Don\'t know' or
                                            v == 'Refused')
                                            else None)
df_statsbinary = df_statsbinary.dropna(subset=['v2529'])
...
output = df_statsbinary['v2529']
inputs = df_statsbinary.drop(['v2528', 'v2529', 'v0717'], axis = 1)    
