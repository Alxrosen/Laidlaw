...
variables = df[['v2500',                            # Education
                ...
                'v2542',                            # other major violations
                'v2543',                            # count other major violations
...
# other major rule violation count
df_statsbinary['v2542'] = df_statsbinary['v2542'].apply(lambda v: 1 if v == 'Yes' else 0)
df_statsbinary['v2543'] = np.where(
    df_statsbinary['v2542'] == 0,  
    0,                       
    df_statsbinary['v2543']      
)
print(df_statsbinary['v2543'].value_counts())
df_statsbinary['v2543'] = df_statsbinary['v2543'].apply(lambda v: int(v) if not \
                                            (v == 'Blank' or
                                            v == 'Don\'t know' or
                                            v == 'Refused')
                                            else None)
df_statsbinary = df_statsbinary.dropna(subset=['v2543'])
...
output = df_statsbinary['v2543']
inputs = df_statsbinary.drop(['v2542', 'v2543', 'v0717'], axis = 1)    
